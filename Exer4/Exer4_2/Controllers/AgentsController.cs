...
namespace Exer4_2.Controllers
{
    public class AgentsController : Controller
    {
        ...
        private readonly SortInterface _service;

        public AgentsController(Ex4DbContext context, SortInterface service)
        {
            _context = context;
            _service = service;
        }
        ...
        {
            var agent = _context.Agents.First(a => a.AgentID == id);
            ViewData["AgentName"] = agent.AgentName;
            return View("BoughtItems", _service.sortBoughtItems(id));
        }
    }
}
